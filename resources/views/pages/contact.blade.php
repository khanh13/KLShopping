...
@section('content')
    ...
    <main class="main">
        ...
        <div class="container">
            <div class="page-header page-header-big text-center" style="background-image: url({{asset('client_assets/assets/images/contact-header-bg.jpg')}})">
            ...
            <div class="container">
                <div class="row">
                                ...
                                <div class="contact-info">
                                    ...
                                    <ul class="contact-list">
                                        ...
                                        <li>
                                            ...
                                            <a href="tel:#">+{{ $site->phone_one }}</a> <br>
                                            <a href="tel:#">+{{ $site->phone_two }}</a>
                                        </li>
                                        <li>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('contact.form') }}" class="contact-form mb-3" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xl-6">
                                        <figure class="store-media mb-2 mb-lg-0">
                                            <img src="{{asset('client_assets/assets/images/stores/img-1.jpg')}}" alt="image">
                        ...
                        <div class="col-lg-6">
                            <div class="store">
                                <div class="row">
                                    <div class="col-sm-5 col-xl-6">
                                        <figure class="store-media mb-2 mb-lg-0">
                                            <img src="{{asset('client_assets/assets/images/stores/img-2.jpg')}}" alt="image">
                                        </figure><!-- End .store-media -->
                                    </div><!-- End .col-xl-6 -->
