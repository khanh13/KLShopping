            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        ...
                        <h2 class="pageheader-title">Edit Blog</h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="inputText3" name="title_en" type="text" class="form-control" value="{{ isset($blog) ? $blog->title_en : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="inputText3" class="col-form-label">Title (Vietnam)</label>
                                            <input id="inputText3" name="title_vi" type="text" class="form-control" value="{{ isset($blog) ? $blog->title_vi : '' }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" class="form-control">
                                                ...
                                                @foreach($blogcategories as $blogcategory)
                                                    <option value="{{ $blogcategory->id }}" @if($blogcategory->id == $blog->category_id) selected @endif>
                                                        {{ $blogcategory->category_name_en }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="details_en" id="summernote" name="editordata" rows="6" placeholder="Write Descriptions">
                                                {{ $blog->details_en }}
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <label class="control-label sr-only" for="summernote">Descriptions </label>
                                            <textarea class="form-control" name="details_vi" id="summernote1" name="editordata" rows="6" placeholder="Write Descriptions">
                                                {{ $blog->details_vi }}
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ URL::to($blog->image) }}" style="max-width: 100%; max-height: 200px" alt="">
