                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="tab-regular">
                        <ul class="nav nav-tabs " id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">All Sub Categories</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <table class="table table-striped table-bordered first">
                                                ...
                                                @foreach($subcategories as $subcategory)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('subcategories.edit', $subcategory->id) }}" class="btn btn-info btn-sm">Edit</a>
{{--                                                            <button id="delete" class="btn btn-danger btn-sm" href="{{route('categories.destroy', $category->id)}}">Delete</button>--}}

                                                            <button class="btn btn-danger btn-sm" onclick="handleDelete({{ $subcategory->id }})">Delete</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('subcategories.store') }}" method="POST">
                                            ...
                                            <button class="btn btn-rounded btn-success">Add Sub Category</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
