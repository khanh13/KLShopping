...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/vendor/datatables/css/dataTables.bootstrap4.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/vendor/datatables/css/buttons.bootstrap4.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/vendor/datatables/css/select.bootstrap4.css') }}">


    <link rel="stylesheet" type="text/css" href="{{ asset('admin_assets/vendor/datatables/css/fixedHeader.bootstrap4.css') }}">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css">

    <link rel="stylesheet" href="{{ asset('admin_assets/vendor/summernote/css/summernote-bs4.css') }}">
@yield('css')
    <title>KLShopping Admin</title>
</head>
...
<script src="{{ asset('admin_assets/vendor/datatables/js/buttons.bootstrap4.min.js') }}"></script>.
<script src="{{ asset('admin_assets/vendor/datatables/js/data-table.js') }}"></script>.
