            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Subscriber</h2>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="tab-regular">
                        <ul class="nav nav-tabs " id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">All Subscribers</a>
                            </li>
                        </ul>
                                            ...
                                            <table class="table table-striped table-bordered first">
                                                ...
                                                @foreach($subscribers as $subscriber)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger btn-sm" onclick="handleDelete({{$subscriber->id}})">Delete</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
